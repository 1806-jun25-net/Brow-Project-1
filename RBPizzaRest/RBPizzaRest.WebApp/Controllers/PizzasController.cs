...
namespace RBPizzaRest.WebApp.Controllers
{
    public class PizzasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Size,Topping,GarlicCrust,OrderId")] MVPizza pizza)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Size,Topping,GarlicCrust,OrderId")] MVPizza pizza)
        {
            if (id != pizza.Id)
            {
                return NotFound();
